...
func TestTransferTxDeadlock(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		// For the odd-numbered transactions, we will send money from account 2 to account 1.
		// For the even-numbered transactions, we will send money from account 1 to accunt 2.
		if i%2 == 1 {
